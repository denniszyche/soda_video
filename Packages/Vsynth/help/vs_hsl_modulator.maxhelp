...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 80.0, 253.0, 307.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 272.0, 120.25, 277.068837739130458, 99.5 ],
					"varname" : "vs_wfg_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 147.0, 334.0, 181.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 280.0, 124.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.0, 124.5, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 389.0, 290.0, 143.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 80.0, 421.0, 225.0, 184.0 ],
					"varname" : "vs_preview",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.5, 471.0, 164.0, 167.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 80.0, 146.0, 140.0, 48.0 ],
					"varname" : "vs_camera_s",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Implements HSL and Pedestal controls, and HSL texture modulation inputs.",
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-20::obj-15" : [ "live.menu[6]", "live.menu", 0 ],
			"obj-20::obj-23" : [ "live.menu[4]", "live.menu", 0 ],
			"obj-20::obj-27" : [ "hslm_sm", "SM", 0 ],
			"obj-20::obj-28" : [ "live.menu[7]", "live.menu", 0 ],
			"obj-20::obj-33" : [ "live.menu[5]", "live.menu", 0 ],
			"obj-20::obj-39" : [ "hslm_hm", "HM", 0 ],
			"obj-20::obj-46" : [ "hslm_hue", "Hue", 0 ],
			"obj-20::obj-47" : [ "hslm_lm", "LM", 0 ],
			"obj-20::obj-48" : [ "hslm_sat", "Sat", 0 ],
			"obj-20::obj-49" : [ "hslm_light", "Light", 0 ],
			"obj-20::obj-53" : [ "hslm_pedestal", "Pedestal", 0 ],
