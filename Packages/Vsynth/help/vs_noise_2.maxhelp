...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 297.5, 322.0, 153.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 32.0, 109.0, 62.0, 40.0 ],
					"varname" : "vs_noise_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 183.0, 225.0, 184.0 ],
					"varname" : "vs_preview",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.5, 52.5, 458.0, 25.0 ],
					"text" : "Interpolable and Resizable White Noise based on Max [jit.noise].",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.5, 0.5, 458.0, 56.0 ],
					"text" : "White Noise 2",
					"textcolor" : [ 0.200000002980232, 0.200000002980232, 0.200000002980232, 1.0 ],
		...
		"parameters" : 		{
			"obj-16::obj-2" : [ "noise2_dim_x", "dim_x", 0 ],
			"obj-16::obj-7" : [ "noise2_interp", "filter", 0 ],
			"parameterbanks" : 			{
