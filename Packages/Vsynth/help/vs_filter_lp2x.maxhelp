...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 607.033333333333303, 89.0, 79.466666666666697, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 105.0, 194.0, 22.0 ],
									"text" : "loadunique vs_Filters_help.maxpat"
								}
...
,
					"patching_rect" : [ 616.033333333333303, 89.0, 39.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 284.0, 368.0, 130.0, 116.0 ],
					"varname" : "vs_scope[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 140.0, 368.0, 130.0, 116.0 ],
					"varname" : "vs_scope",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 284.0, 257.0, 61.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 140.0, 257.0, 61.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 140.0, 107.0, 277.068837739130458, 99.5 ],
					"varname" : "vs_wfg_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 528.5, 443.0, 153.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 135.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.5, 52.5, 687.0, 25.0 ],
					"text" : "Smooth edges in an image with this Gaussian Blur. You can use either the 2x (2-pass xy) or 4x (4-pass xyxy).",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.5, 0.5, 687.0, 56.0 ],
...
, 			{
		...
		"parameters" : 		{
			"obj-16::obj-2" : [ "live.numbox", "live.numbox", 0 ],
			"obj-16::obj-6" : [ "toggle", "live.text", 0 ],
			"obj-17" : [ "live.text", "live.text", 0 ],
			"obj-1::obj-51" : [ "lpf_freq", "Cutoff", 0 ],
			"obj-2::obj-2" : [ "live.numbox[1]", "live.numbox", 0 ],
			"obj-2::obj-6" : [ "toggle[1]", "live.text", 0 ],
			...
			"obj-8::obj-51" : [ "lpf_freq[1]", "Cutoff", 0 ],
			"parameterbanks" : 			{
