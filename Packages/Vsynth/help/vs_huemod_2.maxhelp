...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 143.5, 253.0, 144.0, 75.0 ],
					"varname" : "vs_huemod_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 268.5, 116.5, 277.068837739130458, 99.5 ],
					"varname" : "vs_wfg_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 287.5, 124.5, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.5, 124.5, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 143.0, 367.0, 225.0, 184.0 ],
					"varname" : "vs_preview",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 504.5, 477.0, 164.0, 103.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 103.0, 142.25, 140.0, 48.0 ],
					"varname" : "vs_camera_s",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Same as Hue Modulator 1 with Saturation control.",
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-19::obj-23" : [ "live.menu[12]", "live.menu", 0 ],
			"obj-19::obj-39" : [ "hm2_hm", "HM", 0 ],
			"obj-19::obj-46" : [ "hm2_hue", "Hue", 0 ],
			"obj-19::obj-48" : [ "hm2_sat", "Sat", 0 ],
			"obj-19::obj-5" : [ "live.menu[1]", "live.menu", 0 ],
