...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 734.033333333333303, 83.5, 78.466666666666697, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "loadunique vs_Edges_help.maxpat"
								}
...
,
					"patching_rect" : [ 742.033333333333303, 83.5, 39.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 108.0, 118.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 157.0, 71.0, 22.0 ],
					"text" : "waveform 4"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 197.0, 297.0, 61.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 342.0, 407.0, 130.0, 116.0 ],
					"varname" : "vs_scope[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 197.0, 407.0, 130.0, 116.0 ],
					"varname" : "vs_scope",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 197.0, 150.0, 277.068837739130458, 99.5 ],
					"varname" : "vs_wfg_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 649.5, 543.0, 153.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.5, 52.5, 811.0, 25.0 ],
					"text" : "Enhance borders in an image with this Gaussian High-pass. Very useful in noisy videofeedbacks and for building Edge Detectors.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.5, 0.5, 811.0, 56.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 206.5, 270.0, 351.5, 270.0 ],
					"order" : 0,
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-11::obj-51" : [ "hpf_freq", "Cutoff", 0 ],
