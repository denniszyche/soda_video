...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 594.5, 239.877106000000026, 97.0, 25.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 415.0, 504.5, 46.0, 51.0 ],
					"proportion" : 0.5,
					"rounded" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.0, 276.377106000000026, 76.0, 22.0 ],
					"text" : "prepend tam"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 508.0, 239.877106000000026, 55.0, 22.0 ],
					"text" : "zl slice 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 508.0, 206.877106000000026, 192.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 544.0, 307.377106000000026, 95.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 30.0, 74.0, 223.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 234.0, 120.0, 59.0, 22.0 ],
					"text" : "route amt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 439.0, 240.0, 56.0, 22.0 ],
					"restore" : 					{
						"fdbck_amount" : [ 0.0 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 424.0, 142.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 481.0, 30.0, 30.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 192.0, 379.0, 37.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 155.0, 363.0, 87.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 237.0, 269.0, 81.0, 22.0 ],
									"text" : "param amt 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 147.0, 279.5, 40.0, 22.0 ],
									"text" : "mix"
								}
...
,
					"patching_rect" : [ 30.0, 400.0, 87.0, 22.0 ],
					"text" : "jit.gl.pix vsynth"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 210.0, 47.0, 22.0 ],
					"text" : "pak f 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 234.0, 251.0, 49.0, 22.0 ],
					"text" : "bline 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 328.0, 202.0, 44.0, 22.0 ],
					"text" : "r draw"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 439.0, 110.0, 58.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 234.0, 158.877106000000026, 44.0, 36.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 1.0, 15.0, 44.0, 36.0 ],
...
,
						"valueof" : 						{
							...
							"parameter_longname" : "fdbck_amount",
							"parameter_mmax" : 1.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 234.0, 291.0, 47.0, 22.0 ],
					"text" : "amt $1"
				}
