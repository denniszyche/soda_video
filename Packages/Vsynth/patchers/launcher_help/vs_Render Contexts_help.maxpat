...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 406.499755999999934, 86.0, 20.0 ],
					"style" : "vs_comment",
					"text" : "<- your output.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.5, 207.0, 92.0, 20.0 ],
					"style" : "vs_comment",
					"text" : "<- your window.",
					"textcolor" : [ 0.952941176470588, 0.564705882352941, 0.098039215686275, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 290.0, 164.0, 87.0, 20.0 ],
					"style" : "vs_comment",
					"text" : "<- your render.",
					"textcolor" : [ 0.952941176470588, 0.564705882352941, 0.098039215686275, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 184.0, 131.499755999999991, 168.0, 20.0 ],
					"style" : "vs_comment",
					"text" : "<- bang draw for your context.",
					"textcolor" : [ 0.952941176470588, 0.564705882352941, 0.098039215686275, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 4.0, 6.499755999999991, 325.0, 20.0 ],
					"style" : "vs_comment",
					"text" : "Shows how to make your render context child of Vsynth.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 131.499755999999991, 121.0, 22.0 ],
					"text" : "s your_context_draw"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 30.0, 207.0, 315.0, 22.0 ],
					"text" : "jit.window your_context_name @shared 1 @pos 300 300"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 30.0, 164.0, 258.0, 35.0 ],
					"text" : "jit.gl.render your_context_name @erase_color 0. 0. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.0, 406.499755999999934, 310.0, 35.0 ],
					"text" : "jit.gl.cornerpin your_context_name @preserve_aspect 1 @drawcorners 0 @enable_mouse 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.0, 92.499755999999991, 67.0, 22.0 ],
					"text" : "t b b erase"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 49.499755999999991, 44.0, 22.0 ],
					"text" : "r draw"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 49.0, 371.0, 157.0, 20.0 ],
					"style" : "vs_comment",
					"text" : "<- vsynth generated images",
					"textcolor" : [ 0.952941176470588, 0.564705882352941, 0.098039215686275, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 77.5, 49.499755999999991, 223.0, 20.0 ],
					"style" : "vs_comment",
					"text" : "<- this bang comes from Vsynth Render.",
					"textcolor" : [ 0.952941176470588, 0.564705882352941, 0.098039215686275, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 30.0, 254.5, 278.0, 100.0 ],
					"varname" : "vs_wfg_2",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 39.5, 359.0, 39.5, 359.0 ],
					"source" : [ "obj-3", 0 ]
				}
