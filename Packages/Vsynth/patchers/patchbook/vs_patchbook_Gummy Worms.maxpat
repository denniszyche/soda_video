...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 734.0, 248.0, 203.0, 35.0 ],
					"text" : "name Gummy_Worms, read vs_patchbook_gummyworms.json, 1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 734.0, 298.0, 170.0, 146.0 ],
					"varname" : "vs_presets",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 226.0, 228.0, 140.0, 48.0 ],
					"varname" : "vs_camera_s",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 734.0, 194.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 260.5, 428.0, 159.0, 24.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 12.0, 15.0, 79.0, 316.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 260.5, 312.0, 139.0, 71.0 ],
					"varname" : "vs_luma_key",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 380.5, 60.0, 148.0, 72.0 ],
					"varname" : "vs_edges",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 380.5, 145.0, 178.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 380.5, 228.0, 144.0, 75.0 ],
					"varname" : "vs_huemod_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 534.5, 60.0, 61.0, 71.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "vs_patchbook_gummyworms.json",
					"id" : "obj-10",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 734.0, 418.5, 135.0, 22.0 ],
					"priority" : 					{
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 270.0, 404.0, 610.0, 404.0, 610.0, 34.0, 544.0, 34.0 ],
					"order" : 1,
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-18" : [ "live.text", "live.text", 0 ],
			...
			"obj-33::obj-3" : [ "edges_mode", "live.text", 0 ],
			"obj-33::obj-30" : [ "edges_smth", "Smooth", 0 ],
			"obj-33::obj-51" : [ "edges_freq", "Cutoff", 0 ],
			"obj-34::obj-19" : [ "offrot_angle", "Angle", 0 ],
			"obj-34::obj-35" : [ "offrot_zoom", "Zoom", 0 ],
			"obj-34::obj-4" : [ "MENU[1]", "angle", 0 ],
			"obj-34::obj-6" : [ "offrot_x", "X", 0 ],
			"obj-34::obj-67" : [ "MENU", "angle", 0 ],
			"obj-34::obj-8" : [ "offrot_y", "Y", 0 ],
			"obj-34::obj-9" : [ "MENU[2]", "angle", 0 ],
			"obj-34::obj-96" : [ "offrot_boundmode", "live.menu", 0 ],
			"obj-47::obj-23" : [ "live.menu[22]", "live.menu", 0 ],
			"obj-47::obj-39" : [ "hm2_hm", "HM", 0 ],
			"obj-47::obj-46" : [ "hm2_hue", "Hue", 0 ],
			"obj-47::obj-48" : [ "hm2_sat", "Sat", 0 ],
			"obj-47::obj-5" : [ "live.menu[21]", "live.menu", 0 ],
...
, 			{
				"name" : "vs_patchbook_gummyworms.json",
