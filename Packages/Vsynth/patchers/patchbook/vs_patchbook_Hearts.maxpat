...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 8.0, 9.5, 79.0, 316.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 415.0, 372.0, 49.0, 41.0 ],
					"varname" : "vs_op2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 415.0, 254.0, 92.0, 88.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 515.0, 254.0, 92.0, 88.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "vs_patchbook_hearts.json",
					"hidden" : 1,
					"id" : "obj-11",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 702.0, 661.5, 135.0, 22.0 ],
					"priority" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 719.0, 661.5, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 702.0, 541.0, 170.0, 142.5 ],
					"varname" : "vs_presets",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 515.0, 15.0, 47.0, 65.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 879.0, 545.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 155.0, 118.0, 279.0, 99.0 ],
					"varname" : "vs_wfg_2[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 515.0, 118.0, 279.0, 99.0 ],
					"varname" : "vs_wfg_2",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 415.0, 433.5, 121.0, 73.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 415.0, 526.0, 141.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 879.0, 583.5, 190.0, 35.0 ],
					"text" : "name vs_patchbook_hearts, read vs_patchbook_hearts.json, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 415.0, 621.5, 158.0, 24.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 164.5, 233.0, 495.0, 233.0, 495.0, 104.0, 654.5, 104.0 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 524.5, 81.0, 524.5, 81.0 ],
					"order" : 1,
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 524.5, 92.0, 164.5, 92.0 ],
					"order" : 0,
					"source" : [ "obj-8", 0 ]
				}
		...
		"parameters" : 		{
			"obj-10::obj-1" : [ "comparator_rgb", "live.text", 0 ],
			"obj-10::obj-20" : [ "comparator_thrshld", "thrshld", 0 ],
			"obj-10::obj-25" : [ "comparator_smth", "smth", 0 ],
			"obj-16::obj-1" : [ "toggle", "toggle", 0 ],
			"obj-16::obj-10" : [ "toggle[2]", "toggle[2]", 0 ],
			"obj-16::obj-36" : [ "uppr_x", "uppr_x", 0 ],
			...
			"obj-21::obj-10" : [ "vs_preset_name", "vs_preset_name", 0 ],
			"obj-21::obj-15" : [ "live.tab", "live.tab", 0 ],
			"obj-21::obj-32" : [ "live.numbox", "live.numbox", 0 ],
			...
			"obj-4::obj-31" : [ "hue", "angle", 0 ],
			"obj-4::obj-60" : [ "color", "color", 0 ],
			...
			"obj-8::obj-2" : [ "wfg2_freq[1]", "wfg2_freq", 0 ],
			"obj-8::obj-74" : [ "wfg2_freq_pote", "FREQ", 0 ],
			"parameterbanks" : 			{
