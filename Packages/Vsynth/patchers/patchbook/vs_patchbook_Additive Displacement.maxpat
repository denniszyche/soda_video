...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 843.0, 579.5, 171.0, 146.0 ],
					"varname" : "vs_presets",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 779.0, 650.5, 62.0, 25.0 ],
					"text" : "Initials"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 14.0, 10.0, 79.0, 316.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 683.0, 406.0, 126.0, 122.0 ],
...
, 			{
				"box" : 				{
					"autorestore" : "vs_patchbook_additive_displacement.json",
					"hidden" : 1,
					"id" : "obj-22",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 849.0, 700.0, 135.0, 22.0 ],
					"priority" : 					{
...
,
					...
					"varname" : "vs_patchbook_additive_displacement"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 1021.0, 582.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 482.0, 406.5, 122.0, 72.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 351.0, 406.5, 122.0, 72.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 683.5, 276.5, 322.5, 101.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 351.0, 276.5, 322.5, 101.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 222.0, 142.5, 322.5, 101.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 222.0, 406.5, 122.0, 72.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 275.5, 514.5, 170.0, 108.0 ],
					"varname" : "vs_mixer_3",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 376.0, 45.0, 179.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
					"patching_rect" : [ 222.0, 45.0, 80.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 308.0, 45.0, 61.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 275.5, 683.5, 158.0, 22.0 ],
					"varname" : "vs_output",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1021.0, 613.0, 159.0, 76.0 ],
					"text" : "name vs_patchbook_additive_displacement, read vs_patchbook_additive_displacement.json, 1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 231.5, 127.0, 207.0, 127.0, 207.0, 262.0, 360.5, 262.0 ],
					"order" : 1,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 231.5, 130.5, 693.0, 130.5 ],
					"order" : 0,
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 285.0, 658.0, 178.0, 658.0, 178.0, 17.0, 385.5, 17.0 ],
					"order" : 0,
					"source" : [ "obj-8", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-10::obj-14" : [ "live.menu[1]", "live.menu", 0 ],
			...
			"obj-8::obj-18" : [ "mixer3_master", "MASTER", 0 ],
			"obj-8::obj-2" : [ "mixer3_in_1", "IN1", 0 ],
			"obj-8::obj-3" : [ "mixer3_in_2", "IN2", 0 ],
			"obj-8::obj-4" : [ "mixer3_in_3", "IN3", 0 ],
			"obj-9::obj-19" : [ "offrot_angle", "angle", 0 ],
			"obj-9::obj-35" : [ "offrot_zoom", "zoom", 0 ],
			"obj-9::obj-4" : [ "MENU[1]", "angle", 0 ],
			"obj-9::obj-6" : [ "offrot_x", "x", 0 ],
			"obj-9::obj-67" : [ "offrot_anglemenu", "angle", 0 ],
			"obj-9::obj-8" : [ "offrot_y", "y", 0 ],
			"obj-9::obj-9" : [ "MENU[2]", "angle", 0 ],
			"obj-9::obj-96" : [ "live.menu[7]", "live.menu", 0 ],
			"parameterbanks" : 			{
...
, 			{
				"name" : "vs_patchbook_additive_displacement.json",
...
, 			{
				"name" : "vs_shapes_trig_circle.genjit",
...
, 			{
				"name" : "vs_shapes_trig_polygon.genjit",
				"bootpath" : "~/Documents/Max 8/Packages/Vsynth/code",
				"patcherrelativepath" : "../../code",
				"type" : "gJIT",
				"implicit" : 1
...
, 			{
				"name" : "vs_shapes_trig_rhomb.genjit",
				"bootpath" : "~/Documents/Max 8/Packages/Vsynth/code",
				"patcherrelativepath" : "../../code",
				"type" : "gJIT",
				"implicit" : 1
