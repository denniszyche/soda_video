...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 718.0, 665.0, 359.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 107.0, 679.0, 392.0, 22.0 ],
					"text" : "jit.gl.shader vsynth @file noiseGlasShader.jxs @name noiseGlasShader"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 102.0, 612.0, 564.0, 22.0 ],
					"text" : "jit.gl.mesh vsynth @draw_mode triangles @scale 0.4 0.4 0.4 @shader noiseGlasShader @texture tex01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 704.0, 612.0, 231.0, 22.0 ],
					"text" : "jit.gl.mesh vsynth @shader textureShader"
				}
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Desktop/soda_video/modeltexture01",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
